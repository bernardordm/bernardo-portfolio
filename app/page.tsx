...
export default function PortfolioPage() {
  ...
  const { ref: interestsRef, inView: interestsInView } = useInView({ threshold: 0.5 })
  ...
  }, [heroInView, aboutInView, skillsInView, experienceInView, projectsInView, interestsInView])
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <main className="relative z-10">
        ...
        <section id="about" ref={aboutRef} className="min-h-screen flex items-center justify-center">
          <AboutMeSection inView={aboutInView} />
        </section>
        <section id="skills" ref={skillsRef} className="min-h-screen flex items-center justify-center">
          <SkillsSection inView={skillsInView} />
        </section>
        <section id="experience" ref={experienceRef} className="min-h-screen flex items-center justify-center">
          <ExperiencesSection inView={experienceInView} />
        </section>
        <section id="projects" ref={projectsRef} className="min-h-screen flex items-center justify-center">
          <ProjectsSection inView={projectsInView} />
        </section>
        <section id="interests" ref={interestsRef} className="min-h-screen flex items-center justify-center">
